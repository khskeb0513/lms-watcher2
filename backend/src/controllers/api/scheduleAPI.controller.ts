...
export class ScheduleAPIController {
  ...
  public getAttendanceById(
    @Query("id") id: string,
    @Session() session: Record<string, any>
  ) {
    return this.scheduleService.getAttendanceById(id, session.cookieStr);
  }
  ...
  public getByCourseId(
    ...
    return this.scheduleService.getByEClassId(id, session.cookieStr);
  }
  ...
  public async getVideo(
    ...
    const response = await this.scheduleService.getVideo(
      kjKey,
      seq,
      itemId,
      session.cookieStr
  ...
  public async issueHis(
    ...
    return this.scheduleService.issueHisCode(
      item,
      seq,
      kjKey,
      session.cookieStr
  ...
  public async requestHisStatus(
    ...
    return this.scheduleService.requestHisStatus(
      week,
      item,
      his,
      kjKey,
