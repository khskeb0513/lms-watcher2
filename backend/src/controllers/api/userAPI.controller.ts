...
export class UserAPIController {
  ...
  @Get("/logout")
  public async logout(@Session() session: Record<string, any>) {
  ...
  @Get("/getUsername")
  public async getUsername(@Session() session: Record<string, any>) {
  ...
  @Get("/isSessionValid")
  public async isSessionValid(@Session() session: Record<string, any>) {
    const isSessionAvailable = await this.sessionService.isSessionValid(
      session.cookieStr
    );
  ...
  @Get("/renewSession")
  public async renewSession(@Session() session: Record<string, any>) {
  ...
  public async getSchoolCalendar(@Session() session: Record<string, any>) {
    return {
